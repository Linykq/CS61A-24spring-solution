...
def make_change(amount, coins):
    ...
    if amount < smallest:
        ...
        res_list = make_change(amount - smallest, rest)
        if res_list is None:
            return make_change(amount, rest)
        else:
            return [smallest] + res_list
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if make_change(coin, self.coins) == None:
            ...
            for changed_coin in change_list:
                self.coins[changed_coin] -= 1
                if self.coins[changed_coin] == 0:
                    self.coins.pop(changed_coin)
