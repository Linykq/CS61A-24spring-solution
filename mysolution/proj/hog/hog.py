...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    num_1 = player_score % 10
    num_2 = (opponent_score//10) % 10
    return max(1, 3*(max(num_1, num_2)-min(num_1, num_2)))
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return sus_points(simple_update(num_rolls, player_score, opponent_score, dice=dice))
    # END PROBLEM 4
